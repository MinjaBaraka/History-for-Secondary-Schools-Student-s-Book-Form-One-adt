# History for Secondary Schools Student’s Book Form One — ADT Bundle Reference
...
**History for Secondary Schools Student’s Book Form One** — This is an English-language history textbook from Tanzania for Form One secondary students, roughly equivalent to lower secondary or early high school level. It introduces students to the study of history, human origins and evolution, and the social, economic, political, and educational development of pre-colonial African societies, with strong attention to East Africa alongside examples from West, Central, and Southern Africa. The book reflects a competency-based, activity-centered teaching approach, using revision exercises, source analysis, maps, and illustrations to build historical thinking, patriotism, cultural appreciation, and understanding of African heritage.
...
├── HISTORY-TEXTBOOK-FORM-ONE.db                    # SQLite database (pipeline state)
├── HISTORY-TEXTBOOK-FORM-ONE.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for History for Secondary Schools Student’s Book Form One, approval No. 1185, dated October 23, 2023, signed by the Commissioner for Education.",
  "gl001": "abolition",
  "gl001_def": "the act of officially ending something, especially a law or practice"
}
```
...
```json
{
  "abolition": {
    "word": "abolition",
    "definition": "the act of officially ending something, especially a law or practice",
    "variations": ["abolition","abolish","abolished","abolishing"],
    "emoji": "🛑📜"
  }
}
```
...
```json
{
  "title": "History for Secondary Schools Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-US"
...
| Original PDF | `HISTORY-TEXTBOOK-FORM-ONE.pdf` |
| Pipeline database | `HISTORY-TEXTBOOK-FORM-ONE.db` (SQLite) |
